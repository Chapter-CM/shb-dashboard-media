...
.icon-grp{display:inline-flex;align-items:center;background:var(--glass);border:1px solid var(--stroke);border-radius:12px;overflow:hidden}
.icon-grp .icon-btn{border:none!important;border-radius:0!important;background:none!important}
.icon-grp .icon-btn+.icon-btn{border-left:1px solid var(--stroke)!important}
...
function masthead(mode){
  ...
  return '<div class="mast"><div class="mast-in"><div class="brand"><img class="logo-img" src="'+LOGO_URI+'" alt="SHB"><div><div class="tt">Email Tracker</div><div class="ss">Truyền thông nội bộ · CM Team</div></div></div>'
    ...
    +'<div class="icon-grp"><button class="icon-btn" onclick="openCmd()" data-tip="Lệnh nhanh (Ctrl/⌘+K) — tìm kiếm tính năng">⌘K</button>'
